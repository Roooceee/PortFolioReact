    ...
    <>
      ...
      <section id="mentions-legales" className="background-secondary min-h-[100svh]">
        <div className="margin-auto max-w-[900px] px-5 pt-40 pb-20">
          ...
          <p className="text-sm sm:text-base ">Le site Portfolio Sébastien LUCAS est édité par Sébastien LUCAS.</p>
          <p className="text-sm sm:text-base ">
            Adresse : <span className="numeric">817</span> route de Rougiers <span className="numeric">83470</span>{' '}
          ...
          <p className="text-sm sm:text-base ">
            ...
            <a href="https://vercel.com/" className="text-[var(--color-text)] hover:text-blue-secondary ml-1">
              Vercel
            </a>
            .
          </p>
          ...
          <h3 className="font-title text-blue-primary pb-2.5 pt-5 text-lg sm:text-xl">
          ...
          <p className="text-sm sm:text-base ">
            ...
            <a
              ...
              className="text-[var(--color-text)] hover:text-blue-secondary ml-1">
          ...
          <p className="text-sm sm:text-base ">
            Le formulaire de contact permet de recueillir votre nom, prénom et votre adresse e-mail dans le seul but de
            vous recontacter suite à votre message. Ces informations sont transmises directement via le service
            <a href="https://www.emailjs.com/" className="text-[var(--color-text)] hover:text-blue-secondary mx-1">
              EmailJS
            </a>
            , sans stockage local sur le site ou dans une base de données.
          </p>
          ...
          <p className="text-sm sm:text-base ">
            ...
            <a
              href="mailto:sebastien.jose.lucas@gmail.com"
              className="text-[var(--color-text)] hover:text-blue-secondary mx-1">
              sebastien.jose.lucas@gmail.com
            </a>
          ...
          <p className="text-sm sm:text-base ">
            Les messages sont conservés dans la boîte mail associée à l’adresse mentionnée ci-dessus, pour une durée
            indéterminée, à des fins de suivi de correspondance uniquement.
          </p>
          ...
          <p className="text-sm sm:text-base ">
            ...
            personnelles en envoyant un mail à :
          </p>
          <a
            href="mailto:sebastien.jose.lucas@gmail.com"
            className="text-[var(--color-text)] hover:text-blue-secondary text-sm sm:text-base">
            sebastien.jose.lucas@gmail.com
          </a>

          <h3 className="font-title text-blue-primary pb-2.5 pt-5 text-lg sm:text-xl">Consentement :</h3>
          <p className="text-sm sm:text-base ">
            En utilisant le formulaire de contact, vous consentez à ce que vos données soient traitées de cette manière.
            Vous pouvez retirer votre consentement à tout moment en me contactant directement.
          </p>

          <h2 className="font-title text-blue-primary pb-2.5 pt-5 text-xl sm:text-2xl">Limitation de responsabilité</h2>
          <p className="text-sm sm:text-base ">
            L’éditeur du site ne pourra être tenu responsable en cas de dommage direct ou indirect lié à l’utilisation
            de ce site.
          </p>
        </div>
      </section>
