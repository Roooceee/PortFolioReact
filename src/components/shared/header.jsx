      ...
      <header className="background-primary z-10 fixed top-0 left-0 w-[100%] min-h-[100px]">
        <div className="contain-1440 flex justify-between items-center margin-auto px-3 lg:px-6">
          ...
          <div className="flex items-center gap-8">
            ...
            <nav
              className={`${isOpen ? 'fixed top-[100px] h-[calc(100dvh-100px)]' : 'hidden'} lg:flex lg:relative lg:h-auto lg:top-auto lg:border-t-0 z-50 right-0 left-0 bottom-0 overflow-y-auto border-t border-t-[var(--color-text)] background-primary`}>
              <ul className="flex flex-col gap-5 pt-10 lg:flex-row lg:items-center lg:pt-0">
                ...
                <li>
                  <a
                    ...
                    className={` ${isOpen && 'flex w-fit pb-2.5 margin-auto'} button-blue CV`}>
                    Télécharger mon CV
                  </a>
                </li>
                <li className={`${isOpen && 'w-fit mx-auto'}`}>
                  <ChangeTheme />
                </li>
              </ul>
            </nav>
