...
export const ListLanguagePercent = (props: ListLanguagePercentProps) => {
  const {listLanguagesWithPercent: ListLanguagesWithPercent} = props;
      ...
      {ListLanguagesWithPercent.map((objectLanguage) => {
        return (
          <li
            ...
            <span>
              {objectLanguage.language} <span className="numeric">{objectLanguage.percent}</span>%
            </span>
          </li>
        );
      })}
