...
export const APropos = ({sectionId}) => {
  return (
    <section id={sectionId} className="background-primary section">
      <motion.div
        ...
        <motion.div variants={variants} className="p-2.5 rounded-full bg-blue-primary">
          <img
            src="/img/image_profil_SL.webp"
            alt="image de profil"
            className="rounded-[100%] max-w-[200px] sm:max-w-[300px]"
          />
        </motion.div>
        <div className="grid gap-8">
          ...
          <motion.div variants={containerParagrapheVariants} className="grid gap-8">
            ...
            <motion.p variants={paragraphVariant}>
              Pour faire de ma passion mon métier, début <span className="numeric">2025</span>, j’ai suivi une formation
              professionnelle pour consolider mes bases en HTML, CSS, JavaScript et découvrir React.js ainsi que les
              fondamentaux côté serveur avec PHP. J’y ai renforcé ma logique de développement, appris à manipuler des
              APIs et à créer des interfaces réactives et modernes.
            </motion.p>
            <motion.p variants={paragraphVariant}>
