...
export const Contact = ({sectionId}) => {
  ...
  function sendMail(e) {
    ...
    if (verifyAllField()) {
      ...
      emailjs
        .send('Service_Portfolio_SL', 'Template_Portfolio_SL', templateParams, public_key)
        .then((response) => {
          setCanClose(true);
          setTimeout(() => {
            closeModal();
  ...
  return (
    <>
      <section id={sectionId} className="background-secondary section">
        <div className="contain-1440 margin-auto grid gap-8">
          ...
          <div className="flex flex-col lg:flex-row gap-12 justify-center">
            ...
            <form
              action=""
              className="card-principal grid grid-cols-2 items-start gap-6 max-w-[80%] md:max-w-[750px] margin-auto lg:mx-0">
              ...
              <input
                ...
                className="button-blue col-start-1 col-end-3 cursor-pointer"
      ...
      {loadingSendMessage ? (
        <Modal isOpen={isModalOpen} onClose={closeModal} children={modalContent} showButtonClose={false} />
      ) : (
        <Modal
          isOpen={isModalOpen}
          onClose={closeModal}
