...
export const Experiences = ({sectionId}) => {
  ...
  return (
    <section id={sectionId} className="background-secondary section">
      <div className="contain-1440 grid gap-8 margin-auto min-h-[740px]">
        ...
        {!isReady && !error && <Loading textLoading={'Chargements des expériences en cours'} />}

        {isReady && !error && <Carousel items={experiences} ItemComponent={Experience} />}
